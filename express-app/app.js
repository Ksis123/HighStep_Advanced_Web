...
expressApp.use("/api", require("./api/customer"));
expressApp.use("/api", require("./api/addshoe"));
expressApp.use("/api", require("./api/shoe"));
expressApp.use("/deleteshoe", require("./api/shoe"));
